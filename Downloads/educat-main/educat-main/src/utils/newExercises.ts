...
export const GUIONET_4A: CourseSection[] = [{
  id: 'guionet_4a',
  title: 'El Guionet (C1) 🎯',
  description: '✏️ Recorda: Numerals (D-U-C), pronoms darrere el verb i compostos específics. Compte amb els nous compostos que ja no en porten (com paraxocs o rentaplats)!',
  category: 'ortografia',
  course: '4A',
  exercises: [
    // --- BLOC 1: NUMERALS (Regla D-U-C) ---
    { id: 'g4a_b1_1', type: 'multiple_choice', question: '🔢 Es diu "22". Porta guionet?', options: ['SÍ (vint-i-dos)', 'NO'], correctAnswer: 'SÍ (vint-i-dos)', explanation: 'Regla D-U: Desenes i Unitats se separen amb guionet. ✅', difficulty: 1, course: '4A' },
    { id: 'g4a_b1_2', type: 'multiple_choice', question: '🔢 Es diu "37". Porta guionet?', options: ['SÍ (trenta-set)', 'NO'], correctAnswer: 'SÍ (trenta-set)', explanation: 'Regla D-U. ✅', difficulty: 1, course: '4A' },
    { id: 'g4a_b1_3', type: 'multiple_choice', question: '🔢 Es diu "64". Porta guionet?', options: ['SÍ (seixanta-quatre)', 'NO'], correctAnswer: 'SÍ (seixanta-quatre)', explanation: 'Regla D-U. ✅', difficulty: 1, course: '4A' },
    { id: 'g4a_b1_4', type: 'multiple_choice', question: '🔢 Es diu "500". Porta guionet?', options: ['SÍ (cinc-cents)', 'NO'], correctAnswer: 'SÍ (cinc-cents)', explanation: 'Regla U-C: Unitats i Centenes se separen amb guionet. ✅', difficulty: 1, course: '4A' },
    { id: 'g4a_b1_5', type: 'multiple_choice', question: '🔢 Es diu "2.000". Porta guionet?', options: ['SÍ', 'NO (dos mil)'], correctAnswer: 'NO (dos mil)', explanation: 'Els milers (mil) no s\'uneixen amb guionet. ✅', difficulty: 2, course: '4A' },
    { id: 'g4a_b1_6', type: 'multiple_choice', question: '🔢 Com s\'escriu "421"?', options: ['Quatre-cents vint-i-un', 'Quatrecents vintiun'], correctAnswer: 'Quatre-cents vint-i-un', explanation: 'Porta guionet a U-C i a D-U. ✅', difficulty: 2, course: '4A' },
    { id: 'g4a_b1_7', type: 'multiple_choice', question: '🔢 "99" porta guionet?', options: ['SÍ (noranta-nou)', 'NO'], correctAnswer: 'SÍ (noranta-nou)', explanation: 'Regla D-U sempre. ✅', difficulty: 1, course: '4A' },
    { id: 'g4a_b1_8', type: 'multiple_choice', question: '🔢 "300" porta guionet?', options: ['SÍ (tres-cents)', 'NO'], correctAnswer: 'SÍ (tres-cents)', explanation: 'Regla U-C sempre. ✅', difficulty: 1, course: '4A' },
    { id: 'g4a_b1_9', type: 'multiple_choice', question: '🔢 Com s\'escriu "2.500"?', options: ['Dues mil cinc-centes', 'Dues-mil cinc-centes'], correctAnswer: 'Dues mil cinc-centes', explanation: 'Mil no s\'uneix, però "cinc-centes" sí (U-C). ✅', difficulty: 2, course: '4A' },
    { id: 'g4a_b1_10', type: 'multiple_choice', question: '🔢 "88" porta guionet?', options: ['SÍ (vuitanta-vuit)', 'NO'], correctAnswer: 'SÍ (vuitanta-vuit)', explanation: 'Regla D-U sempre. ✅', difficulty: 1, course: '4A' },
    { id: 'g4a_b1_11', type: 'multiple_choice', question: '🔢 "19" porta guionet?', options: ['SÍ', 'NO (dinou)'], correctAnswer: 'NO (dinou)', explanation: 'Dinou és una paraula simple. ✅', difficulty: 1, course: '4A' },
    { id: 'g4a_b1_12', type: 'multiple_choice', question: '🔢 "73" porta guionet?', options: ['SÍ (setanta-tres)', 'NO'], correctAnswer: 'SÍ (setanta-tres)', explanation: 'Regla D-U sempre. ✅', difficulty: 1, course: '4A' },
    { id: 'g4a_b1_13', type: 'multiple_choice', question: '🔢 "1100" porta guionet?', options: ['SÍ', 'NO (mil cent)'], correctAnswer: 'NO (mil cent)', explanation: '"Mil" i "Cent" no s\'uneixen entre ells. ✅', difficulty: 2, course: '4A' },
    { id: 'g4a_b1_14', type: 'multiple_choice', question: '🔢 "42" porta guionet?', options: ['SÍ (quaranta-dos)', 'NO'], correctAnswer: 'SÍ (quaranta-dos)', explanation: 'Regla D-U sempre. ✅', difficulty: 1, course: '4A' },
    { id: 'g4a_b1_15', type: 'multiple_choice', question: '💰 "5.000.000" porta guionet?', options: ['SÍ', 'NO (cinc milions)'], correctAnswer: 'NO (cinc milions)', explanation: '"Milió" i "miliards" són noms i no s\'uneixen. ✅', difficulty: 2, course: '4A' },

    // --- BLOC 2: PARAULES COMPOSTES (Repeticions i Onomatopeies) ---
    { id: 'g4a_b2_1', type: 'multiple_choice', question: '🚶‍♂️ Com s\'escriu "Paso a paso / Despacio"?', options: ['Xino-xano', 'Xinoxano'], correctAnswer: 'Xino-xano', explanation: 'Les repeticions de mots se separen amb guionet. ✅', difficulty: 2, course: '4A' },
    { id: 'g4a_b2_2', type: 'multiple_choice', question: '〰️ Indica la forma correcta:', options: ['Ziga-zaga', 'Zigazaga'], correctAnswer: 'Ziga-zaga', explanation: 'Onomatopeies i repeticions porten guionet. ✅', difficulty: 2, course: '4A' },
    { id: 'g4a_b2_3', type: 'multiple_choice', question: '⏰ El so del rellotge és:', options: ['Tic-tac', 'Tictac'], correctAnswer: 'Tic-tac', explanation: 'Onomatopeia amb guionet. ✅', difficulty: 1, course: '4A' },
    { id: 'g4a_b2_4', type: 'multiple_choice', question: '😲 Algú molt sorprès o corprès:', options: ['Cor-près', 'Corprès'], correctAnswer: 'Cor-près', explanation: 'Compost amb guionet. ✅', difficulty: 3, course: '4A' },
    { id: 'g4a_b2_5', type: 'multiple_choice', question: '🤝 Un combat cos a cos:', options: ['Mano-mano', 'Manomano'], correctAnswer: 'Mano-mano', explanation: 'Repetició amb guionet. ✅', difficulty: 2, course: '4A' },
    { id: 'g4a_b2_6', type: 'multiple_choice', question: '🐕 El gos fa...', options: ['Bup-bup', 'Bupbup'], correctAnswer: 'Bup-bup', explanation: 'Onomatopeia. 🐶', difficulty: 1, course: '4A' },
    { id: 'g4a_b2_7', type: 'multiple_choice', question: '🥕 Un plat típic:', options: ['Nap-i-col', 'Napicol'], correctAnswer: 'Nap-i-col', explanation: 'Compost amb conjunció intercalada. ✅', difficulty: 2, course: '4A' },
    { id: 'g4a_b2_8', type: 'multiple_choice', question: '🌊 So del rierol:', options: ['Rierol-rierol', 'Rierolrierol'], correctAnswer: 'Rierol-rierol', explanation: 'Repetició. ✅', difficulty: 2, course: '4A' },
    { id: 'g4a_b2_9', type: 'multiple_choice', question: '👗 Estar penjat de qualsevol manera:', options: ['Pengim-penjam', 'Pengimpenjam'], correctAnswer: 'Pengim-penjam', explanation: 'Expressió amb guionet. ✅', difficulty: 3, course: '4A' },
    { id: 'g4a_b2_10', type: 'multiple_choice', question: '🏃 Fer les coses molt ràpid:', options: ['Corre-cuita', 'Correcuita'], correctAnswer: 'Corre-cuita', explanation: 'Compost amb guionet. ✅', difficulty: 2, course: '4A' },
    { id: 'g4a_b2_11', type: 'multiple_choice', question: '🤫 Parlar en veu baixa:', options: ['Xiu-xiu', 'Xiuxiu'], correctAnswer: 'Xiu-xiu', explanation: 'Onomatopeia/Repetició. ✅', difficulty: 1, course: '4A' },
    { id: 'g4a_b2_12', type: 'multiple_choice', question: '💡 Estar tot viu/actiu:', options: ['Garrat-i-viu', 'Garrativiu'], correctAnswer: 'Garrat-i-viu', explanation: 'Expressió amb guionet. ✅', difficulty: 3, course: '4A' },
    { id: 'g4a_b2_13', type: 'multiple_choice', question: '🍽️ L\'electrodomèstic per als plats:', options: ['Rentaplats', 'Renta-plats'], correctAnswer: 'Rentaplats', explanation: 'Nova normativa: "Rentaplats" va tot junt (excepció). 🛑', difficulty: 3, course: '4A' },
    { id: 'g4a_b2_14', type: 'multiple_choice', question: '🚗 El protector dels xocs:', options: ['Paraxocs', 'Para-xocs'], correctAnswer: 'Paraxocs', explanation: 'Nova normativa: "Paraxocs" va tot junt. 🛑', difficulty: 3, course: '4A' },
    { id: 'g4a_b2_15', type: 'multiple_choice', question: '🗺️ Direcció geogràfica (Eura + Est):', options: ['Eura-est', 'Euraest'], correctAnswer: 'Eura-est', explanation: 'Guionet necessari per evitar el xoc de vocals idèntiques (a-e no, però e-e sí). ✅', difficulty: 3, course: '4A' },

    // --- BLOC 3: PRONOMS FEBLES (Combina verb i pronom) ---
    { id: 'g4a_b3_1', type: 'multiple_choice', question: '🎁 "Dona" + "me" + "la":', options: ['Dona-me-la', 'Donamela'], correctAnswer: 'Dona-me-la', explanation: 'Verbs i pronoms se separen amb guionet si no s\'apostrofen. ✅', difficulty: 2, course: '4A' },
    { id: 'g4a_b3_2', type: 'multiple_choice', question: '🗣️ "Digues" + "li":', options: ['Digues-li', 'Diguesli'], correctAnswer: 'Digues-li', explanation: 'Porta guionet. ✅', difficulty: 1, course: '4A' },
    { id: 'g4a_b3_3', type: 'multiple_choice', question: '🚶 "Anem" + "nos" + "en":', options: ['Anem-nos-en', 'Anem-nos en'], correctAnswer: 'Anem-nos-en', explanation: 'S\'uneixen tots amb guionet. ✅', difficulty: 2, course: '4A' },
    { id: 'g4a_b3_4', type: 'multiple_choice', question: '🍎 "Menja" + "et" + "ho":', options: ['Menja-t\'ho', 'Menja t\'ho'], correctAnswer: 'Menja-t\'ho', explanation: 'El guionet uneix el verb al bloc de pronoms. ✅', difficulty: 2, course: '4A' },
    { id: 'g4a_b3_5', type: 'multiple_choice', question: '📦 "Porta" + "ho":', options: ['Porta-ho', 'Portaho'], correctAnswer: 'Porta-ho', explanation: 'La "h" no impedeix el guionet (no s\'apostrofa). ✅', difficulty: 2, course: '4A' },
    { id: 'g4a_b3_6', type: 'multiple_choice', question: '🛒 "Compri" + "els":', options: ['Compri\'ls', 'Compri-ls'], correctAnswer: 'Compri\'ls', explanation: 'S\'apostrofa perquè el verb acaba en vocal i el pronom comença en vocal. ❌ No guionet.', difficulty: 3, course: '4A' },
    { id: 'g4a_b3_7', type: 'multiple_choice', question: '🎁 "Dona" + "em" + "ho":', options: ['Dona\'m-ho', 'Dona-m-ho'], correctAnswer: 'Dona\'m-ho', explanation: 'Dona\'m (apòstrof) - ho (guionet). ✅', difficulty: 3, course: '4A' },
    { id: 'g4a_b3_8', type: 'multiple_choice', question: '👂 "Escolta" + "ens":', options: ['Escolta\'ns', 'Escolta-nos'], correctAnswer: 'Escolta\'ns', explanation: 'S\'apostrofa quan és possible. ✅', difficulty: 2, course: '4A' },
    { id: 'g4a_b3_9', type: 'multiple_choice', question: '📦 "Porteu" + "els" + "el":', options: ['Porteu-los-el', 'Porte-los el'], correctAnswer: 'Porteu-los-el', explanation: 'Trencament de pronoms combinats. ✅', difficulty: 3, course: '4A' },
    { id: 'g4a_b3_10', type: 'multiple_choice', question: '🪞 "Mira" + "et":', options: ['Mira\'t', 'Mira-te'], correctAnswer: 'Mira\'t', explanation: 'S\'apostrofa prefrentment. ✅', difficulty: 1, course: '4A' },
    { id: 'g4a_b3_11', type: 'multiple_choice', question: '👉 "Fes" + "ho":', options: ['Fes-ho', 'Fesho'], correctAnswer: 'Fes-ho', explanation: 'Sempre amb guionet. ✅', difficulty: 1, course: '4A' },
    { id: 'g4a_b3_12', type: 'multiple_choice', question: '🛒 "Compra" + "els" + "en":', options: ['Compra\'ls-en', 'Compra-ls en'], correctAnswer: 'Compra\'ls-en', explanation: 'Compra\'ls (apòstrof) - en (guionet). ✅', difficulty: 3, course: '4A' },
    { id: 'g4a_b3_13', type: 'multiple_choice', question: '💰 "Vendre" + "els":', options: ['Vendre\'ls', 'Vendre-ls'], correctAnswer: 'Vendre\'ls', explanation: 'L\'apòstrof guanya al guionet. ✅', difficulty: 2, course: '4A' },
    { id: 'g4a_b3_14', type: 'multiple_choice', question: '📍 "Anar" + "hi":', options: ['Anar-hi', 'Anar hi'], correctAnswer: 'Anar-hi', explanation: 'Guionet amb "hi" darrere infinitiu. ✅', difficulty: 1, course: '4A' },
    { id: 'g4a_b3_15', type: 'multiple_choice', question: '👗 "Portar" + "les":', options: ['Portar-les', 'Portar les'], correctAnswer: 'Portar-les', explanation: 'Pronom enclític. ✅', difficulty: 1, course: '4A' },

    // --- BLOC 4: PUNT CARDINALS I PREFIXOS ---
    { id: 'g4a_b4_1', type: 'multiple_choice', question: '🌎 Relatiu al sud d\'Amèrica:', options: ['Sud-americà', 'Sudamericà'], correctAnswer: 'Sud-americà', explanation: 'Punts cardinals compostos porten guionet. ✅', difficulty: 2, course: '4A' },
    { id: 'g4a_b4_2', type: 'multiple_choice', question: '🧭 Entre el nord i l\'oest:', options: ['Nord-oest', 'Nordoest'], correctAnswer: 'Nord-oest', explanation: 'Punts cardinals amb guionet. ✅', difficulty: 2, course: '4A' },
    { id: 'g4a_b4_3', type: 'multiple_choice', question: '🧭 Entre el sud i l\'est:', options: ['Sud-est', 'Sudest'], correctAnswer: 'Sud-est', explanation: 'Punts cardinals amb guionet. ✅', difficulty: 2, course: '4A' },
    { id: 'g4a_b4_4', type: 'multiple_choice', question: '📅 El dia abans d\'ahir:', options: ['Despús-ahir', 'Despusahir'], correctAnswer: 'Despús-ahir', explanation: 'Expressió amb guionet. ✅', difficulty: 2, course: '4A' },
    { id: 'g4a_b4_5', type: 'multiple_choice', question: '📅 El dia després de demà:', options: ['Despús-demà', 'Despusdemà'], correctAnswer: 'Despús-demà', explanation: 'Expressió amb guionet. ✅', difficulty: 2, course: '4A' },
    { id: 'g4a_b4_6', type: 'multiple_choice', question: '👨‍🦳 El pare del pare:', options: ['Besavi', 'Bes-avi'], correctAnswer: 'Besavi', explanation: 'El prefix "Bes-" no porta guionet davant vocal normal. ✅', difficulty: 3, course: '4A' },
    { id: 'g4a_b4_7', type: 'multiple_choice', question: '👨‍💼 El germà de l\'avi:', options: ['Bes-oncle', 'Besoncle'], correctAnswer: 'Bes-oncle', explanation: 'Porta guionet per evitar la lectura errònia o xoc de vocals. ✅', difficulty: 3, course: '4A' },
    { id: 'g4a_b4_8', type: 'multiple_choice', question: '👔 Persona que ja no és president:', options: ['Expresident', 'Ex-president'], correctAnswer: 'Expresident', explanation: 'Nova normativa: Els prefixos van generalment junts. 🛑', difficulty: 3, course: '4A' },
    { id: 'g4a_b4_9', type: 'multiple_choice', question: '👩‍💼 Persona que ja no és directora:', options: ['Exdirectora', 'Ex-directora'], correctAnswer: 'Exdirectora', explanation: 'Prefix "ex" va junt. ✅', difficulty: 2, course: '4A' },
    { id: 'g4a_b4_10', type: 'multiple_choice', question: '⚔️ Atacar com a resposta:', options: ['Contraatacar', 'Contra-atacar'], correctAnswer: 'Contraatacar', explanation: 'Va tot junt. ✅', difficulty: 2, course: '4A' },

    // --- BLOC 5: MIX D\'ERRORS (Correcte / Incorrecte) ---
    { id: 'g4a_b5_1', type: 'multiple_choice', question: '🔢 "Vint i tres" és...', options: ['Incorrecte → Vint-i-tres', 'Correcte'], correctAnswer: 'Incorrecte → Vint-i-tres', explanation: 'Falta el guionet D-U. ❌', difficulty: 1, course: '4A' },
    { id: 'g4a_b5_2', type: 'multiple_choice', question: '🍚 "Arròs-amb-llet" és...', options: ['Incorrecte → Arròs amb llet', 'Correcte'], correctAnswer: 'Incorrecte → Arròs amb llet', explanation: 'No calen guionets en aquest compost. ❌', difficulty: 2, course: '4A' },
    { id: 'g4a_b5_3', type: 'multiple_choice', question: '🐢 "Poc-a-poc" és...', options: ['Incorrecte → Poc a poc', 'Correcte'], correctAnswer: 'Incorrecte → Poc a poc', explanation: 'Les locucions d\'aquest tipus van sense guionets. ✅', difficulty: 2, course: '4A' },
    { id: 'g4a_b5_4', type: 'multiple_choice', question: '↔️ "D\'aquí-allà" és...', options: ['Incorrecte → D\'aquí allà', 'Correcte'], correctAnswer: 'Incorrecte → D\'aquí allà', explanation: 'Sense guionet. ❌', difficulty: 2, course: '4A' },
    { id: 'g4a_b5_5', type: 'multiple_choice', question: '👗 "Penja-robes" és...', options: ['Incorrecte → Penjarobes', 'Correcte'], correctAnswer: 'Incorrecte → Penjarobes', explanation: 'Nova normativa: Penjarobes va junt. 🛑', difficulty: 3, course: '4A' },
    { id: 'g4a_b5_6', type: 'multiple_choice', question: '🔢 "Vuit-cents" és...', options: ['Correcte', 'Incorrecte'], correctAnswer: 'Correcte', explanation: 'U-C porta guionet. ✅', difficulty: 1, course: '4A' },
    { id: 'g4a_b5_7', type: 'multiple_choice', question: '🏖️ "Vora-mar" és...', options: ['Incorrecte → Voramar', 'Correcte'], correctAnswer: 'Incorrecte → Voramar', explanation: 'Voramar és una sola paraula. ✅', difficulty: 2, course: '4A' },
    { id: 'g4a_b5_8', type: 'multiple_choice', question: '☀️ "Para-sol" és...', options: ['Incorrecte → Parasol', 'Correcte'], correctAnswer: 'Incorrecte → Parasol', explanation: 'Nova normativa: Parasol va junt. 🛑', difficulty: 2, course: '4A' },
    { id: 'g4a_b5_9', type: 'multiple_choice', question: '💌 "Mata-segells" és...', options: ['Incorrecte → Matasegells', 'Correcte'], correctAnswer: 'Incorrecte → Matasegells', explanation: 'Matasegells va junt. ✅', difficulty: 3, course: '4A' },
    { id: 'g4a_b5_10', type: 'multiple_choice', question: '🏘️ "Bell-lloc" és...', options: ['Correcte', 'Incorrecte'], correctAnswer: 'Correcte', explanation: 'Guionet per evitar el xoc de L. ✅', difficulty: 2, course: '4A' },
    { id: 'g4a_b5_11', type: 'multiple_choice', question: '🐦 "Pit-roig" és...', options: ['Correcte', 'Incorrecte'], correctAnswer: 'Correcte', explanation: 'Ocell amb guionet. ✅', difficulty: 2, course: '4A' },
    { id: 'g4a_b5_12', type: 'multiple_choice', question: '🦵 "Cama-llarg" és...', options: ['Correcte', 'Incorrecte'], correctAnswer: 'Correcte', explanation: 'Compost amb guionet. ✅', difficulty: 2, course: '4A' },
    { id: 'g4a_b5_13', type: 'multiple_choice', question: '😲 "Déu-n\'hi-do" és...', options: ['Correcte', 'Incorrecte'], correctAnswer: 'Correcte', explanation: 'Interjecció lexicalitzada. ✅', difficulty: 1, course: '4A' },
    { id: 'g4a_b5_14', type: 'multiple_choice', question: '🧵 "Fil-a-l\'agulla" és...', options: ['Incorrecte → Fil a l\'agulla', 'Correcte'], correctAnswer: 'Incorrecte → Fil a l\'agulla', explanation: 'Locució sense guionets. ❌', difficulty: 2, course: '4A' },
    { id: 'g4a_b5_15', type: 'multiple_choice', question: '🔢 "Cinc-cents setanta-nou" és...', options: ['Correcte', 'Incorrecte'], correctAnswer: 'Correcte', explanation: 'Guionet a U-C i D-U. ✅', difficulty: 2, course: '4A' }
  ]
}];
